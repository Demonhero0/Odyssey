...
func (f FuzzingConfig) MarshalJSON() ([]byte, error) {
	...
	enc.BranchCoverageEnabled = f.BranchCoverageEnabled
	enc.StorageWriteEnabled = f.StorageWriteEnabled
	...
	if f.SenderAddressesBalances != nil {
		enc.SenderAddressesBalances = make([]*hexutil.Big, len(f.SenderAddressesBalances))
		for k, v := range f.SenderAddressesBalances {
			enc.SenderAddressesBalances[k] = (*hexutil.Big)(v)
		}
	}
	...
	enc.VariableRecoverConfig = f.VariableRecoverConfig
	enc.OnChainFuzzingConfig = f.OnChainFuzzingConfig
...
func (f *FuzzingConfig) UnmarshalJSON(input []byte) error {
	...
	if dec.BranchCoverageEnabled != nil {
		f.BranchCoverageEnabled = *dec.BranchCoverageEnabled
	}
	if dec.StorageWriteEnabled != nil {
		f.StorageWriteEnabled = *dec.StorageWriteEnabled
	}
	...
	if dec.SenderAddressesBalances != nil {
		f.SenderAddressesBalances = make([]*big.Int, len(dec.SenderAddressesBalances))
		for k, v := range dec.SenderAddressesBalances {
			f.SenderAddressesBalances[k] = (*big.Int)(v)
		}
	}
	...
	if dec.VariableRecoverConfig != nil {
		f.VariableRecoverConfig = *dec.VariableRecoverConfig
	}
	if dec.OnChainFuzzingConfig != nil {
		f.OnChainFuzzingConfig = *dec.OnChainFuzzingConfig
	}
	if dec.StateGuidedConfig != nil {
		f.StateGuidedConfig = *dec.StateGuidedConfig
	}
	if dec.MetricRecordConfig != nil {
		f.MetricRecordConfig = *dec.MetricRecordConfig
	}
