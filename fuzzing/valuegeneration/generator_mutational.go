...
func NewMutationalValueGenerator(config *MutationalValueGeneratorConfig, valueSet *ValueSet, randomProvider *rand.Rand) *MutationalValueGenerator {
	...
	// add some general seeds
	generator.valueSet.AddInteger(big.NewInt(1000))
	generator.valueSet.AddInteger(big.NewInt(100000))
	generator.valueSet.AddInteger(big.NewInt(100000000000000000))
	generator.valueSet.AddInteger(big.NewInt(1000000000000000000))
	generator.valueSet.AddInteger(abi.MaxInt256)
	generator.valueSet.AddInteger(abi.MaxUint256)
	return generator
}
...
func (g *MutationalValueGenerator) GenerateAddress() common.Address {
	...
	// fmt.Println("MutationalValueGenerator GenerateAddress", randomGeneratorDecision, g.config.GenerateRandomAddressBias, address)
	return address
}
...
func (g *MutationalValueGenerator) ValueSet() *ValueSet {
	return g.valueSet
}
