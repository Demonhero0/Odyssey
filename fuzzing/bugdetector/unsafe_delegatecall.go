...
func isUnsafeDelegatecallTaintSourceMemory(opcode byte, scope *vm.ScopeContext) (bool, uint64, uint64) {
...
func isUnsafeDelegatecallTaintMemorySunk(ta *TaintAnalyzer, scope *vm.ScopeContext) bool {
	scopeContext := scope
...
func detect_unsafe_delegatecall(tracer *BugDetectorTracer, pc uint64, opcode byte, scope *vm.ScopeContext) {
