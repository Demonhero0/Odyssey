...
func isOverflowTaintSource(opcode byte, scope *vm.ScopeContext) bool {
	scopeContext := scope
...
func detect_overflow(tracer *BugDetectorTracer, pc uint64, opcode byte, scope *vm.ScopeContext) {
