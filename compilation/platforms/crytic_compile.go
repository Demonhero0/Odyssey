...
func (c *CryticCompilationConfig) CheckAndLoadExistCompilations() ([]types.Compilation, error) {
	...
	// Find compilation artifacts in the export directory
	matches, err := filepath.Glob(filepath.Join(exportDirectory, "*solc.json"))
	if err != nil {
		return nil, err
	}
